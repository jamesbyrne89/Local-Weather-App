$(document).ready(function() {
  ...
  var geolocation_API_key = 'AIzaSyCNm6K1v3q-YcbKABgJWjwpvYTlBrQ5JBM';
  ...
  function success(position) {
    ...
    var reversegeocodingapi = `https://maps.googleapis.com/maps/api/geocode/json?latlng=${lat}%2C${lon}&key=${geolocation_API_key}`;
    $.getJSON(reversegeocodingapi, function(place) {
      for (var i = 0; i < place.results[0].address_components.length; i++) {
        ...
        if (
          place.results[0].address_components[i].types[0] ===
      ...
      function error() {
        alert(
          "Geolocation requires a secure connection to work. Please add 'https://' to the beginning of this page's URL. (i.e. 'https://codepen.io/bethqiang/full/bZrZpa')"
        );
      }
      ...
      $.getJSON(
        ...
        function(wd) {
          ...
          var precipChance = (wd.daily.data[0].precipProbability * 100).toFixed(
            0
          );
          ...
          $('#day-one-forecast-temp-hi').html(
            fiveDayForecast[0].temperatureMax + '&deg;'
          );
          $('#day-one-forecast-temp-lo').html(
            fiveDayForecast[0].temperatureMin + '&deg;'
          );
          $('#day-two-forecast-temp-hi').html(
            fiveDayForecast[1].temperatureMax + '&deg;'
          );
          $('#day-two-forecast-temp-lo').html(
            fiveDayForecast[1].temperatureMin + '&deg;'
          );
          $('#day-three-forecast-temp-hi').html(
            fiveDayForecast[2].temperatureMax + '&deg;'
          );
          $('#day-three-forecast-temp-lo').html(
            fiveDayForecast[2].temperatureMin + '&deg;'
          );
          $('#day-four-forecast-temp-hi').html(
            fiveDayForecast[3].temperatureMax + '&deg;'
          );
          $('#day-four-forecast-temp-lo').html(
            fiveDayForecast[3].temperatureMin + '&deg;'
          );
          $('#day-five-forecast-temp-hi').html(
            fiveDayForecast[4].temperatureMax + '&deg;'
          );
          $('#day-five-forecast-temp-lo').html(
            fiveDayForecast[4].temperatureMin + '&deg;'
          );
          ...
          if (currentIcon == 'clear-day') {
            $('#weather-icon-wrapper-left').html(
              "<i class='wi wi-day-sunny current-weather-icon'></i>"
            );
          } else if (currentIcon === 'clear-night') {
            $('#weather-icon-wrapper-left').html(
              "<i class='wi wi-night-clear current-weather-icon'></i>"
            );
          } else if (currentIcon === 'rain') {
            $('#weather-icon-wrapper-left').html(
              "<i class='wi wi-day-rain current-weather-icon'></i>"
            );
          } else if (currentIcon === 'snow') {
            $('#weather-icon-wrapper-left').html(
              "<i class='wi wi-day-snow current-weather-icon'></i>"
            );
          } else if (currentIcon === 'sleet') {
            $('#weather-icon-wrapper-left').html(
              "<i class='wi wi-day-sleet current-weather-icon'></i>"
            );
          } else if (currentIcon === 'wind') {
            $('#weather-icon-wrapper-left').html(
              "<i class='wi wi-day-windy current-weather-icon'></i>"
            );
          } else if (currentIcon === 'fog') {
            $('#weather-icon-wrapper-left').html(
              "<i class='wi wi-day-fog current-weather-icon'></i>"
            );
          } else if (currentIcon === 'cloudy') {
            $('#weather-icon-wrapper-left').html(
              "<i class='wi wi-day-cloudy current-weather-icon'></i>"
            );
            ...
            $('#weather-icon-wrapper-left').html(
              "<i class='wi wi-night-partly-cloudy current-weather-icon'></i>"
            );
          } else {
            $('#weather-icon-wrapper-left').html(
              "<i class='wi wi-day-sunny current-weather-icon'></i>"
          ...
          if (dayOneIcon == 'clear-day') {
            $('#icon-day-one').html(
              "<i class='wi wi-day-sunny forecast-list-icons'></i>"
            );
          } else if (dayOneIcon === 'clear-night') {
            $('#icon-day-one').html(
              "<i class='wi wi-night-clear forecast-list-icons'></i>"
            );
          } else if (dayOneIcon === 'rain') {
            $('#icon-day-one').html(
              "<i class='wi wi-day-rain forecast-list-icons'></i>"
            );
          } else if (dayOneIcon === 'snow') {
            $('#icon-day-one').html(
              "<i class='wi wi-day-snow forecast-list-icons'></i>"
            );
          } else if (dayOneIcon === 'sleet') {
            $('#icon-day-one').html(
              "<i class='wi wi-day-sleet forecast-list-icons'></i>"
            );
          } else if (dayOneIcon === 'wind') {
            $('#icon-day-one').html(
              "<i class='wi wi-day-windy forecast-list-icons'></i>"
            );
          } else if (dayOneIcon === 'fog') {
            $('#icon-day-one').html(
              "<i class='wi wi-day-fog forecast-list-icons'></i>"
            );
          } else if (dayOneIcon === 'cloudy') {
            $('#icon-day-one').html(
              "<i class='wi wi-day-cloudy forecast-list-icons'></i>"
            );
            ...
            $('#icon-day-one').html(
              "<i class='wi wi-night-partly-cloudy forecast-list-icons'></i>"
            );
          } else {
            $('#icon-day-one').html(
              "<i class='wi wi-day-sunny current-weather-icon'></i>"
          ...
          $('input[type=checkbox]').change(function() {
            if (this.checked) {
              $('#current-temp')
                .addClass('.current-temp-far')
                .removeClass('.current-temp')
                .html(convertToFahrenheit(currentTemp) + '&deg;');
              $('#current-temp')
                .css('margin-left', '0px')
              ...
              $('#day-one-forecast-temp-hi').html(
                convertToFahrenheit(dayOneMax) + '&deg;'
              );
              $('#day-one-forecast-temp-lo').html(
                convertToFahrenheit(dayOneMin) + '&deg;'
              );
              $('#day-two-forecast-temp-hi').html(
                convertToFahrenheit(dayTwoMax) + '&deg;'
              );
              $('#day-two-forecast-temp-lo').html(
                convertToFahrenheit(dayTwoMin) + '&deg;'
              );
              $('#day-three-forecast-temp-hi').html(
                convertToFahrenheit(dayThreeMax) + '&deg;'
              );
              $('#day-three-forecast-temp-lo').html(
                convertToFahrenheit(dayThreeMin) + '&deg;'
              );
              $('#day-four-forecast-temp-hi').html(
                convertToFahrenheit(dayFourMax) + '&deg;'
              );
              $('#day-four-forecast-temp-lo').html(
                convertToFahrenheit(dayFourMin) + '&deg;'
              );
              $('#day-five-forecast-temp-hi').html(
                convertToFahrenheit(dayFiveMax) + '&deg;'
              );
              $('#day-five-forecast-temp-lo').html(
                convertToFahrenheit(dayFiveMin) + '&deg;'
              );
            } else {
              $('#current-temp')
                .addClass('.current-temp')
                .removeClass('.current-temp-far')
                .html(currentTemp + '&deg;');
              $('#current-temp')
                .css('text-align', 'center')
